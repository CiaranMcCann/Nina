var Coin = (function () {
    function Coin(xInPixels, yInPixels, coinType) {
    ...
    Coin.prototype.beginContact = function (contact) {
        ...
        if(this.coinType == Coin.COIN_TYPE.water) {
            if(a instanceof Walter) {
                ...
                this.isAlive = false;
                AssetManager.getSound("marioCoin").play(0.5);
    ...
    Coin.prototype.endContact = function (contact) {
    };
    ...
    Coin.prototype.setUpPhysics = function (xInPixels, yInPixels) {
